        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-left">
            <p className="text-body-base text-gray-300">
              © 2024 G7Team2. All rights reserved.
            </p>
          </div>
          ...
          <div className="flex items-center gap-6">
            <a
              ...
              className="text-gray-300 hover:text-tertiary transition-colors duration-200"
              aria-label="Twitter"
            >
              <svg
                className="w-6 h-6"
          ...
          >
            <ArrowUpIcon className="w-5 h-5" strokeWidth={1.5} />
          </Button>
        </div>
      </div>
    </footer>
